...
<h2><center>### Atualizar Quantidade de Produtos ###</center></h2>
<br>
<b>
	<body>
		<center>
			<form id="cadastro" name="cadastro" method="post" action="gravar_qtde.php" onsubmit="return validaCampo(); return false;">
				<table width="625" border="0">
					...
					<tr>
						<td>Quantidade:</td>
						<td><input type="number" name="qtde" id="qtde" min="1" max="10" />
						</td>
					</tr>
					<tr>
